...
mkdir -p $RPM_BUILD_ROOT/opt/cantemo/portal/portal_themes/gnm/templates/media
cp -a /opt/cantemo/portal/portal_themes/gnm/templates/media/media_view.html $RPM_BUILD_ROOT/opt/cantemo/portal/portal_themes/gnm/templates/media/media_view.html
cp -a /opt/cantemo/portal/portal_themes/gnm/templates/media/media_inc_preview.html $RPM_BUILD_ROOT/opt/cantemo/portal/portal_themes/gnm/templates/media/media_inc_preview.html
mkdir -p $RPM_BUILD_ROOT/opt/cantemo/portal/portal_media/gnm/css
cp -a /opt/cantemo/portal/portal_media/gnm/css/logos.css $RPM_BUILD_ROOT/opt/cantemo/portal/portal_media/gnm/css/logos.css
