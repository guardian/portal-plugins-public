...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RestoreRequest.file_size'
        db.alter_column('gnmawsgr_restorerequest', 'file_size', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'RestoreRequest.currently_downloaded'
        db.alter_column('gnmawsgr_restorerequest', 'currently_downloaded', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'RestoreRequest.file_size'
        db.alter_column('gnmawsgr_restorerequest', 'file_size', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'RestoreRequest.currently_downloaded'
        db.alter_column('gnmawsgr_restorerequest', 'currently_downloaded', self.gf('django.db.models.fields.IntegerField')(null=True))
