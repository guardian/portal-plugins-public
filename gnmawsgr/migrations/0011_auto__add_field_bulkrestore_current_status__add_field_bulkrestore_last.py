...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BulkRestore.current_status'
        db.add_column('gnmawsgr_bulkrestore', 'current_status',
                      self.gf('django.db.models.fields.CharField')(default='Queued', max_length=32),
                      keep_default=False)

        # Adding field 'BulkRestore.last_error'
        db.add_column('gnmawsgr_bulkrestore', 'last_error',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BulkRestore.current_status'
        db.delete_column('gnmawsgr_bulkrestore', 'current_status')

        # Deleting field 'BulkRestore.last_error'
        db.delete_column('gnmawsgr_bulkrestore', 'last_error')
