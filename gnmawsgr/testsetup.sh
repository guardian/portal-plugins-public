...
sudo cp -a portal_theme_files/media_view.html /opt/cantemo/portal/portal_themes/gnm/templates/media/media_view.html
sudo chown ubuntu /opt/cantemo/portal/portal_themes/gnm/templates/media/media_view.html
sudo cp -a portal_theme_files/media_inc_preview.html /opt/cantemo/portal/portal_themes/gnm/templates/media/media_inc_preview.html
...
sudo cp -a portal_theme_files/logos.css /opt/cantemo/portal/portal_media/gnm/css/logos.css
...
sudo cp -a portal_theme_files/axe.gif /opt/cantemo/portal/portal_media/img/gnm/logos/axe.gif
sudo chown ubuntu /opt/cantemo/portal/portal_media/img/gnm/logos/axe.gif
sudo cp -a portal_theme_files/archived.png /opt/cantemo/portal/portal_media/img/gnm/logos/archived.png
sudo chown ubuntu /opt/cantemo/portal/portal_media/img/gnm/logos/archived.png
sudo cp -a portal_theme_files/restored.png /opt/cantemo/portal/portal_media/img/gnm/logos/restored.png
sudo chown ubuntu /opt/cantemo/portal/portal_media/img/gnm/logos/restored.png
sudo cp -a portal_theme_files/delete.png /opt/cantemo/portal/portal_media/delete.png
