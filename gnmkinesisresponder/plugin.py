...
class GnmkinesisresponderPluginURL(Plugin):
    ...
    def __init__(self):
        self.name = "Test Kinesis responder"
        self.urls = 'portal.plugins.gnmkinesisresponder.urls'
        self.urlpattern = r'^gnmkinesisresponder/'
        self.namespace = r'gnmkinesisresponder'
        self.plugin_guid = 'c6192389-f763-4ec5-bd1e-5ce050c9f24a'
        log.debug("Initiated Gnmkinesisresponder App")
...
class GnmkinesisresponderRegister(Plugin):
    ...
    def __init__(self):
        self.name = "Gnmkinesisresponder Registration App"
