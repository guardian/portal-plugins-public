...
from views import GetStatsView, GetLibraryStats, MediaProjectAttachmentDataView
...
urlpatterns = patterns('portal.plugins.gnmplutostats.views',
    ...
    url(r'^collection_stats/', MediaProjectAttachmentDataView.as_view(), name='gnmplutostats_collection_stats')
)
