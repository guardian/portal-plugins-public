...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportJob.atom_id'
        db.add_column('gnmatomresponder_importjob', 'atom_id',
                      self.gf('django.db.models.fields.CharField')(default=-1, max_length=64, db_index=True),
                      keep_default=False)

        # Adding field 'ImportJob.retry_number'
        db.add_column('gnmatomresponder_importjob', 'retry_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportJob.atom_id'
        db.delete_column('gnmatomresponder_importjob', 'atom_id')

        # Deleting field 'ImportJob.retry_number'
        db.delete_column('gnmatomresponder_importjob', 'retry_number')
