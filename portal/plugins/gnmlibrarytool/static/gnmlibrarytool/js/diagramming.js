...
function iterate_query(rules, container, prefix){
    ...
    $.each(rules, function(idx, r) {
        ...
        var box;
        if(r.type=='field'){
            box = $("<div>", {'id': prefix + '_r' + idx, 'class': 'rule_box'});
            ...
            box = $("<div>", {'id': prefix + '_r' + idx, 'class': 'operator_box'});
            container.append(box);
...
function iterate_rules(rules, container, prefix){
    ...
    $.each(rules, function(key, r) {
        ...
        var new_exclude_box = $("<ul>", {'class': 'rule_list'});
        $.each(r.exclude, function(idx,v){
            new_exclude_box.append($("<li>").html(v));
        });
        box.append(new_exclude_box);
