...
class TestTemplates(django.test.TestCase):
    ...
    def test_my_optins(self):
        ...
        self.assertIn('<li>No items yet.  Why not <a href=', rendered_content)
    ...
    def test_delete_optins(self):
        ...
        self.assertIn('<form action="" method="post">', rendered_content)
        self.assertIn('<p>Are you sure you want to delete ""?</p>', rendered_content)
    ...
    def test_user_profile_menu(self):
        ...
        self.assertIn('<span class="iicon" style="background-position:-197px -334px"></span>Add Opt-In</a>', rendered_content)
