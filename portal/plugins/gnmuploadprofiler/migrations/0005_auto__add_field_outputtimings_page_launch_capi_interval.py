...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OutputTimings.page_launch_capi_interval'
        db.add_column('gnmuploadprofiler_outputtimings', 'page_launch_capi_interval',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OutputTimings.page_launch_capi_interval'
        db.delete_column('gnmuploadprofiler_outputtimings', 'page_launch_capi_interval')
